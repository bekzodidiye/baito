          ...
          {!selectedRegion && searchText ? (
            ...
            <>
              ...
              <button 
                ...
                className="w-full bg-indigo-50/50 hover:bg-indigo-50 border border-indigo-100/50 p-4 rounded-xl shadow-xs transition-all flex items-center group text-left cursor-pointer active:scale-99 outline-none focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary/20"
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] text-brand-primary/80 mt-0.5 font-medium leading-normal">
                    Butun viloyat bo'ylab qidirish
                  </p>
                </div>
