...
const getJobDetails = (title: string) => {
          ...
          <div className="px-4 -mt-6 relative z-10">
            ...
            <section className="mt-6">
              <div className="flex items-center justify-between mb-2">
                ...
                {distanceToSelectedJob ? (
                  <span className="text-[11px] text-brand-primary font-bold flex items-center gap-1">
                    <Navigation size={11} className="rotate-45 text-brand-primary fill-brand-primary/20" />
                    Masofa: {distanceToSelectedJob}
                  </span>
                ) : (
                  <button
                    onClick={handleCalculateDistance}
                    disabled={isLocating}
                    className="text-[11px] text-brand-primary hover:underline font-bold flex items-center gap-1 cursor-pointer disabled:opacity-75"
                  >
                    <Navigation size={11} className="rotate-45" />
                    {isLocating ? "Hisoblanmoqda..." : "Masofani o'lchash"}
                  </button>
                )}
              </div>
              ...
              <div className="w-full h-36 rounded-xl overflow-hidden border border-slate-100 relative shadow-xs">
                ...
                <button
                  ...
                  className="absolute bottom-2 right-2 bg-white/95 backdrop-blur-xs px-2.5 py-1 rounded-lg text-[10px] font-bold text-brand-primary shadow-sm border border-slate-100 cursor-pointer"
                >
                  Xaritada ochish →
                </button>
              </div>
