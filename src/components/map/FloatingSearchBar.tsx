  ...
  return (
    ...
    >
      <div 
        ...
        className="flex items-center gap-3 bg-white rounded-2xl px-4 py-3 shadow-[0_4px_20px_rgba(0,0,0,0.06)] hover:bg-slate-50 hover:shadow-[0_4px_22px_rgba(0,0,0,0.08)] transition-all cursor-pointer active:scale-98 select-none outline-none focus:outline-none border-0 ring-0"
      >
