  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className="bg-white rounded-t-[28px] shadow-[0_-12px_30px_rgba(0,0,0,0.06)] pb-3 cursor-pointer"
      >
                ...
                {displayedJobs.map(job => {
                  ...
                  return (
                    <motion.div
                      ...
                      className={`snap-center shrink-0 min-w-[calc(100vw-64px)] max-w-[calc(100vw-64px)] sm:min-w-[322px] sm:max-w-[322px] p-4 rounded-2xl flex flex-col gap-1.5 relative transition-all duration-300 cursor-pointer border border-slate-100 shadow-[0_4px_16px_rgba(0,0,0,0.03)] ${
                        selectedJob?.id === job.id
                          ? 'bg-brand-primary/5 ring-2 ring-brand-primary/30 translate-y-[-2px]'
                          : 'bg-white hover:shadow-[0_12px_24px_rgba(0,0,0,0.08)] hover:translate-y-[-2px]'
