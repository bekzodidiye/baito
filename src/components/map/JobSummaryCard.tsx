            ...
            <p className="text-xs font-bold text-brand-text-variant">
              {displayedJobs.length === 0 ? (
                filterLocation === 'Barchasi'
                  ? "O'zbekiston bo'ylab ishlar topilmadi"
                  : `${filterLocation} bo'ylab ishlar topilmadi`
              ) : (
                filterLocation === 'Barchasi'
                  ? `O'zbekiston bo'ylab ${displayedJobs.length} ta ish topildi`
                  : `${filterLocation} bo'ylab ${displayedJobs.length} ta ish topildi`
              )}
            </p>
