          ...
          {(() => {
            ...
            if (selectedJob.status === 'completed') {
              return (
                <button
                  disabled
                  className="flex-1 text-white h-14 rounded-xl text-sm font-bold shadow-md bg-brand-primary opacity-90 cursor-not-allowed flex items-center justify-center gap-2"
                >
