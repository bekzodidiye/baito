  ...
  return (
    <section className="flex flex-col gap-4 bg-white p-4 rounded-2xl shadow-sm">
      <div className="relative flex-1">
        ...
        <input
          type="text"
          className="w-full bg-white hover:bg-slate-50/50 text-brand-text font-sans rounded-full py-3.5 pl-12 pr-4 shadow-[0_4px_12px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.06)] border-0 focus:bg-white focus:outline-none focus:ring-2 focus:ring-brand-primary/30 transition-all placeholder:text-brand-outline text-sm"
      ...
      <div className="relative w-full">
        ...
        <div ref={scrollContainerRef} className="flex items-center gap-2 overflow-x-auto no-scrollbar pb-1 w-full flex-nowrap">
          <button
            ...
            className={`flex items-center gap-2 px-3.5 py-1.5 rounded-full transition-all whitespace-nowrap text-xs font-semibold cursor-pointer shrink-0 border-0 outline-none focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary/20 ${
              showFilters 
                ...
                : 'bg-white text-brand-text-variant shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.06)] hover:bg-slate-50'
            }`}
          >
          ...
          <button
            ...
            className="flex items-center gap-1 px-3 py-1.5 rounded-full bg-white text-brand-text-variant shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.06)] hover:bg-slate-50 text-xs font-semibold cursor-pointer whitespace-nowrap shrink-0 transition-all border-0 outline-none focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary/20"
          >
